    ...
    <div class="container py-8">
        ...
        {{-- <div id="accordion-collapse" data-accordion="collapse">
            <h2 id="accordion-collapse-heading-1">
                <button type="button"
                    ...
                    <span>¿Qué marcas y productos distribuye Digital WD?</span>
            ...
            <div id="accordion-collapse-body-1" class="hidden" aria-labelledby="accordion-collapse-heading-1">
                <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700 dark:bg-gray-900">
                    <p class="mb-2 text-gray-500 dark:text-gray-400">
                        Digital WD distribuye una amplia gama de productos tecnológicos de marcas reconocidas a nivel mundial, incluyendo:
                    </p>
                    <p class="mb-2 text-gray-500 dark:text-gray-400">
                        •	Smartphones: Samsung, Apple, Xiaomi, Motorola, Huawei, entre otras. <br>
                        •	Computadoras: Laptops, desktops, tablets, all-in-one, de las marcas HP, Lenovo, ASUS, Acer, Dell, entre otras. <br>
            ...
            <h2 id="accordion-collapse-heading-2">
                <button type="button"
                    ...
                    <span>¿Puedo encontrar el producto que busco en la tienda online?</span>
                    <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0" aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 5 5 1 1 5" />
            ...
            <div id="accordion-collapse-body-2" class="hidden" aria-labelledby="accordion-collapse-heading-2">
                <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700">
                    <p class="mb-2 text-gray-500 dark:text-gray-400">
                        Sí, puedes encontrar una gran variedad de productos en nuestra tienda online. Utiliza la barra de búsqueda para encontrar el producto 
                        específico que deseas o navega por las diferentes categorías y subcategorías para descubrir nuevos productos.
                    </p>
                </div>
            </div>
            <h2 id="accordion-collapse-heading-3">
                <button type="button"
                    ...
                    <span>¿Cómo puedo verificar la disponibilidad de un producto en una tienda física?</span>
                    <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0" aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 5 5 1 1 5" />
            ...
            <h2 id="accordion-collapse-heading-4">
                <button type="button"
                    ...
                    <span>¿Qué garantías ofrecen los productos que venden?</span>
                    <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0" aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 5 5 1 1 5" />
            ...
            <div id="accordion-collapse-body-4" class="hidden" aria-labelledby="accordion-collapse-heading-4">
                <div class="p-5 border border-t-0 border-gray-200 dark:border-gray-700">
                    <p class="mb-2 text-gray-500 dark:text-gray-400">
                        Todos los productos que vendemos cuentan con la garantía oficial del fabricante. 
                        La duración de la garantía varía según el producto, pero generalmente es de 1 año. Puedes encontrar información más detallada sobre 
                        la garantía de cada producto en su ficha técnica.
                    </p>
                </div>
            </div>
            ...
            <h2 id="accordion-collapse-heading-5">
                <button type="button"
                    ...
                    <span>¿Cómo puedo realizar una devolución o cambio de producto?</span>
                    <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0" aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 5 5 1 1 5" />
            ...
            <div id="accordion-collapse-body-5" class="hidden" aria-labelledby="accordion-collapse-heading-5">
                <div class="p-5 border border-t-0 border-gray-200 dark:border-gray-700">
                    <p class="mb-2 text-gray-500 dark:text-gray-400">
                        Para realizar una devolución o cambio de producto, debes comunicarte con nuestro servicio de
                         atención al cliente. Te guiaremos en el proceso y te brindaremos toda la información necesaria.
                    </p>
                </div>
            </div>
            ...
            <h2 id="accordion-collapse-heading-6">
                <button type="button"
                    ...
                    <span>¿Qué métodos de pago puedo utilizar para comprar en Digital WD?</span>
                    <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0" aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 5 5 1 1 5" />
            ...
            <div id="accordion-collapse-body-6" class="hidden" aria-labelledby="accordion-collapse-heading-6">
                <div class="p-5 border border-t-0 border-gray-200 dark:border-gray-700">
                    <p class="mb-2 text-gray-500 dark:text-gray-400">
                        En Digital WD, puedes utilizar diversos métodos de pago para realizar tus compras: <br>
                        •	Pago en línea: Tarjeta de crédito o débito, PSE, Efecty. <br>
                        •	Pago contraentrega: Paga en efectivo al recibir tu pedido. <br>
                        •	Pago en tienda: Puedes realizar el pago en cualquiera de nuestras tiendas físicas.                        
                    </p>
                </div>
            </div>
            ...
            <h2 id="accordion-collapse-heading-7">
                <button type="button"
                    ...
                    <span>¿Es seguro comprar en la tienda online de Digital WD?</span>
                    <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0" aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 5 5 1 1 5" />
            ...
            <div id="accordion-collapse-body-7" class="hidden" aria-labelledby="accordion-collapse-heading-7">
                <div class="p-5 border border-t-0 border-gray-200 dark:border-gray-700">
                    <p class="mb-2 text-gray-500 dark:text-gray-400">
                        Sí, comprar en la tienda online de Digital WD es completamente seguro. Implementamos las mejores prácticas de 
                        seguridad para proteger tus datos personales y financieros. Contamos con certificados de seguridad SSL y utilizamos 
                        pasarelas de pago seguras para procesar tus transacciones.
                    </p>
                </div>
            </div>
            ...
            <h2 id="accordion-collapse-heading-8">
                <button type="button"
                    ...
                    <span>¿Cómo puedo realizar el seguimiento de mi pedido?</span>
                    <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0" aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 5 5 1 1 5" />
            ...
            <div id="accordion-collapse-body-8" class="hidden" aria-labelledby="accordion-collapse-heading-8">
                <div class="p-5 border border-t-0 border-gray-200 dark:border-gray-700">
                    <p class="mb-2 text-gray-500 dark:text-gray-400">
                        Una vez que hayas realizado tu pedido, recibirás un correo electrónico de confirmación con un enlace para rastrear tu pedido. 
                        También puedes verificar el estado de tu pedido en tu cuenta en la página web.
                    </p>
                </div>
            </div>
            ...
            <div id="accordion-collapse-body-9" class="hidden" aria-labelledby="accordion-collapse-heading-9">
                <div class="p-5 border border-t-0 border-gray-200 dark:border-gray-700">
                    <p class="mb-2 text-gray-500 dark:text-gray-400">
                        El tiempo de entrega de tu pedido dependerá del método de envío que hayas elegido y de la disponibilidad del producto. 
                        En general, los pedidos se entregan en un plazo de 2 a 5 días hábiles.
                    </p>
                </div>
            </div>
            ...
            <div id="accordion-collapse-body-10" class="hidden" aria-labelledby="accordion-collapse-heading-10">
                <div class="p-5 border border-t-0 border-gray-200 dark:border-gray-700">
                    <p class="mb-2 text-gray-500 dark:text-gray-400">
                        Los costos de envío varían según el método de envío que hayas elegido y el destino del pedido.
                         Puedes encontrar información detallada sobre los costos de envío en la página web.
                    </p>
                </div>
            </div>
            ...
            <h2 id="accordion-collapse-heading-11">
                <button type="button"
                    ...
                    <span>¿Cómo puedo crear una cuenta en Digital WD?</span>
                    <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0" aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 5 5 1 1 5" />
            ...
            <div id="accordion-collapse-body-11" class="hidden" aria-labelledby="accordion-collapse-heading-11">
                <div class="p-5 border border-t-0 border-gray-200 dark:border-gray-700">
                    <p class="mb-2 text-gray-500 dark:text-gray-400">
                        Crear una cuenta en Digital WD es muy sencillo. Solo tienes que completar un formulario con tus datos personales en la página web.
                    </p>
                </div>
            </div>
            ...
            <h2 id="accordion-collapse-heading-12">
                <button type="button"
                    ...
                    <span>¿Cuáles son los beneficios de tener una cuenta en Digital WD?</span>
                    <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0" aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 5 5 1 1 5" />
            ...
            <h2 id="accordion-collapse-heading-13">
                <button type="button"
                    ...
                    <span>¿Cómo puedo modificar mis datos de cuenta?</span>
                    <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0" aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 5 5 1 1 5" />
        ...
        {{-- <h2 id="accordion-collapse-heading-14">
            ...
            <div id="accordion-collapse-body-14" class="hidden" aria-labelledby="accordion-collapse-heading-14">
                <div class="p-5 border border-t-0 border-gray-200 dark:border-gray-700">
                    <p class="mb-2 text-gray-500 dark:text-gray-400">
                        Si has olvidado tu contraseña, puedes recuperarla haciendo clic en el enlace "Olvidé mi contraseña" en la
                         página de inicio de sesión. Se te enviará un correo electrónico con instrucciones para restablecer tu contraseña.
                    </p>
                </div>
            </div> --}}
        ...
        {{-- <h2 id="accordion-collapse-heading-15">
                <button type="button"
                    ...
                    <span>¿Cuántas tiendas físicas tiene Digital WD?</span>
                    <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0" aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 5 5 1 1 5" />
            ...
            <h2 id="accordion-collapse-heading-16">
                <button type="button"
                    ...
                    <span>¿Cuál es el numero o contacto de la sede principal?</span>
                    <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0" aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 5 5 1 1 5" />
            ...
            <h2 id="accordion-collapse-heading-17">
                <button type="button"
                    class="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-gray-200 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3"
                    data-accordion-target="#accordion-collapse-body-17" aria-expanded="false"
                    aria-controls="accordion-collapse-body-17">
                    <span>¿Dónde está ubicada la sede principal de Digital WD?</span>
                    <svg data-accordion-icon class="w-3 h-3 rotate-180 shrink-0" aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                            d="M9 5 5 1 1 5" />
