<x-admin-layout>
    ...
    <form action="{{ route('admin.covers.update', $cover) }}" 
            ...
            <figure class="relative mb-4">
                ...
                <img src="{{ $cover->image }}" class="aspect-[3/1] w-full object-cover object-center border border-gray-300 rounded-lg"
                    id="imgPreview">
            </figure>
            ...
            <div class="mb-4">
                ...
                <x-jet-input type="text" class="w-full" value="{{ old('title') }}" name="title" placeholder="Ingrese el titulo de la publicidad" />
