    ...
    <footer class="bg-neutral-800 text-center text-neutral-100 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
        <div
            ...
            <div class="flex justify-center">
                <a href="https://www.facebook.com/profile.php?id=100076258636002" target="_blank" class="mr-6 text-neutral-500 hover:text-neutral-300 dark:text-neutral-200">
                ...
                <a href="mailto:digitalbaq@gmail.com" target="_blank" class="mr-6 text-neutral-500 hover:text-neutral-300 dark:text-neutral-200">
                ...
                <a href="https://www.instagram.com/digitalwdhome/" target="_blank" class="mr-6 text-neutral-500 hover:text-neutral-300 dark:text-neutral-200">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
                        <path
