...
<head>
    ...
    <script>
        ...
        fbq('init', '1011423373679681');
        fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"
            src="https://www.facebook.com/tr?id=1011423373679681&ev=PageView&noscript=1" /></noscript>
    <!-- End Meta Pixel Code -->
...
<body class="font-sans antialiased">
    ...
    <footer class="bg-neutral-800 text-center text-neutral-100 dark:bg-neutral-600 dark:text-neutral-200 lg:text-left">
        ...
        <div class="bg-neutral-900 p-6 text-center dark:bg-neutral-700">
            ...
            <div class="mt-8 text-sm">Designed by <a class="hover:text-rojo-600"
                    href="https://github.com/wilbertdaniel2">Wilbert Avila F</a></div>
        </div>
    </footer>
</body>
