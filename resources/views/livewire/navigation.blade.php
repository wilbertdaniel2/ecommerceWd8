<header class="bg-neutral sticky top-0" x-data="dropdown()">
    ...
    <nav id="navigation-menu" 
        ...
        @auth
                <a href="{{ route('profile.show') }}" class="py-2 px-4 text-sm flex items-center text-truegray hover:bg-red hover:text-white">
            ...
            @else
                ...
                <a href="{{ route('login') }}" class="py-2 px-4 text-sm flex items-center text-truegray hover:bg-red hover:text-white">
                ...
                <a href="{{ route('register') }}" class="py-2 px-4 text-sm flex items-center text-truegray hover:bg-red hover:text-white">
